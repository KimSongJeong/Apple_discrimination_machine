...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
                        ...
                        <div class="col-sm-12">
							...
							<div class="container nav-second">
								<ul class="nav nav-tabs">
									<li class="nav-item"><a class="nav-link active nav-a-tag" id="members" data-toggle="tab" href="#memberAdmin">회원관리</a></li>
								...
								<div class="col-sm-12 tab-pane fade" id="question">
										<table class="table-member table-striped table-hover">
											...
											<tr>
												<td>${qvo.q_seq}</td>
												<td>${qvo.q_title}</td>
												<td class="contentTd">${qvo.q_content}</td>
												<td>${qvo.reg_date}</td>
												<td>${qvo.q_file}</td>
												<td>${qvo.mb_id}</td>
											</tr>
		...
		<!-- <script type = "text/javascript">
			...
			function memberJSON(data){
				
				var html ='<table class="table-member table-striped table-hover">'; 
				html += '<tr>';
				html += '<td>회원 아이디</td>';
				html += '<td>이름</td>';
				html += '<td>주소</td>';
				...
				$.each(data, function(index,obj){
					...
					html += '<td>'+obj.mb_name+'</td>';
					html += '<td>'+obj.mb_addr+'</td>';
					html += '<td>'+obj.mb_phone+'</td>';
					html += '<td>'+obj.mb_joindate+'</td>';
				...
				if($('#memberAdmin').css('display')=='block'){
					$('#memberAdmin').slideUp();
				}else{
					$('#memberAdmin'),slideDown();
				}
