			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
					...
					<ul class="navbar-nav ml-auto align-items-center">
						...
						<li class="nav-item">
							<a class="nav-link" href="#services">제품 및 솔루션</a>
						</li>
						<li class="nav-item">
			...
			<section class="testimonial" id="testimonial">
				<div class="container big-area">
					<div class="row backbutton">
						<a href="data.do"><img class="backButton" alt="나의 농산물 관리로 돌아가기" src="<c:url value="/resources/images/back-button.png" />"></a>
					</div>
					<div class="row  mt-md-0 mt-lg-5">
						<div class="data-area col-sm-12 text-body ">
                            <h5>분류된 데이터 현황</h5>
                            <table class="agridata table table-striped table-hover">
                                ...
                                <c:forEach var="cvo" items="${applelist}">
