				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
					...
					<ul class="navbar-nav ml-auto align-items-center">
						<li class="nav-item active">
							<a class="nav-link" href="mainIdex.do">Home<span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item">
				...
				<div class="container">
					<div class="row mb-5 pb-5 login-center">
						<div class="col-sm-7 loginform-center" data-aos="fade-up" data-aos-offset="-500">
							<h3 class="font-weight-medium text-dark mt-5 mt-lg-0">회원가입 하기</h3>
							<h5 class="text-dark mb-5">서비스를 이용하기 위해서는 <br>로그인이 필요합니다.</h5>
							<form class="loginform-center" action="joinInsert.do" method="post">
								<div class="row">
									<div class="col-sm-12">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<input type="text" class="form-control" id="name" placeholder="이름" name="mb_name">
										</div>
									</div>
									<div class="col-sm-12">
										<div class="form-group">
											<input type="text" class="form-control" id="address" placeholder="주소" name="mb_addr">
										</div>
									</div>
									<div class="col-sm-12">
										<div class="form-group">
											<input type="text" class="form-control" id="tel" placeholder="전화번호" name="mb_phone">
										</div>
									</div>
									<div class="col-sm-12">
										<input type="submit" class="btn btn-secondary" value="회원가입하기">
										<!-- submit 누르면 DB에 잘 들어가면 login.do로 갈 수 있도록 설정하기/아니면 그대로 join.do 실행 -->
										<!-- 일단은 afterlogin.do로.....? -->
									</div>
								</div>
							</form>
